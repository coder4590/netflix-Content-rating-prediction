...
def predict_data():
    ...
    x=df.drop(['description','rating','show_id','date_added','title', 'director', 'cast',
                'country','listed_in','duration','rating_encoded'], axis=1)
    y=df['rating_encoded']
    ...
    search = RandomizedSearchCV(estimator=RandomForestClassifier(n_estimators=42),
    ...
    print(f"accuracy for rf: {accuracy:.3f}")
